      ...
      >
        ...
        <div className="px-6 py-7 space-y-6">
          ...
          <div className="flex items-center gap-2.5">
            <img src="/logo.png" alt="Mmuta" className="w-7 h-7 rounded-lg" />
            <span className="text-[13px] font-bold text-slate-700 dark:text-slate-300 tracking-tight">Mmuta</span>
            <span className="text-slate-300 dark:text-slate-600 text-xs">·</span>
            <span className="text-[11px] text-slate-400 dark:text-slate-500 font-mono uppercase tracking-wider">Academic Portal</span>
          </div>
